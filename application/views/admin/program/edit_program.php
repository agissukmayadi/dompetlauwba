        ...
        <div class="row">
            <div class="col-md-7">
                <div class="p-5">
                    ...
                    <form class="user" action="<?= base_url('Program/update') ?>" method="post"
                        enctype="multipart/form-data">

                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="id_program"
                                id="exampleInputEmail" placeholder="program" value="<?= $program['id_program'] ?>"
                                hidden>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="program"
                                id="exampleInputEmail" placeholder="program" value="<?= $program['program'] ?>"
                                required>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="latest"
                                id="exampleInputEmail" placeholder="latest" value="<?= $program['gambar'] ?>" hidden>
                        </div>

                        <div class="form-group">
                            <textarea type="text" class="form-control" rows="10" name="deskripsi" id="exampleInputEmail"
                                placeholder="deskripsi" required><?= $program['deskripsi'] ?>
                                    </textarea>
                        </div>
