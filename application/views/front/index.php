  ...
  <div class="w3l-banner-content">
    <div class="container">
      <div class="bannerhny-info text-center">
        ...
        <a class="btn btn-style btn-white mt-sm-5 mt-4" href="<?= base_url('Front/donasi') ?>">
          Donasi</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="content-info-in row">
        ...
        <div class="content-left col-lg-8 d-inline justify-content-center">
          <h5 style="text-align:center">Donasi Masuk</h5>
          <?php
          $totalDonasi = $this->Donasi_m->total_donasi();

          ?>
          <div class="progress mt-3 mb-2">
            <div class="progress-bar bg-success" role="progressbar"
              style="width:<?= (intval($totalDonasi['nominal']) / 100000000) * 100 ?>%" aria-valuemin="0"
              aria-valuemax="100"></div>
          </div>
          <medium>Rp.
            <?= number_format($totalDonasi['nominal']) ?>
          </medium>
          <div class="text-center mt-4">
            <p>
              <?= wordwrap('Donasi yang telah anda berikan akan kami kumpulkan dan akan disalurkan ke beberapa', 80, '<br>') ?>
              <a href="<?= base_url('Front/program') ?>">program yang kami miliki</a>
            </p>
          </div>
        </div>
      </div>
