...
--
-- Host: localhost:3306
-- Generation Time: May 27, 2024 at 08:40 PM
...
(1, 'wildan', '$2y$10$kKfH1t3xw2Wf/6GwqnvTnOPeMznj6us9u6Q.nVIDL5dzA7jXvYMXm');
...
INSERT INTO `bank` (`id_bank`, `atas_nama`, `nama_bank`, `no_rek`) VALUES
(1, 'Agis Sukmayadi', 'BCA', '1287618542'),
(2, 'BRI', 'Luki Supriyadi', '89163661342'),
(3, 'Muhammad Arifin', 'BTN', '2867186864');
...
INSERT INTO `contact` (`id_contact`, `gambar`, `deskripsi`, `alamat`, `telp`, `email`) VALUES
(1, '1716477327.png', 'Lauwba Techno Indonesia merupakan perusahaan yang bergerak dibidang teknologi informasi khususnya IT Consultant, Software Development, IT Training & Digital Marketing dengan SKT.KEMENKUMHAM RI NO AHU-0022789.AH.01.01', 'Gedung PT. Lauwba Techno Indonesia, Jl. Karangploso Sitimulyo, Karang Ploso, Sitimulyo, Kec. Piyungan, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55792', '027444359440', 'info@lauwba.com');
...
CREATE TABLE `donate` (
  `id_donation` char(6) NOT NULL,
  `id_bank` int(11) NOT NULL,
  `email` varchar(128) NOT NULL,
  `no_rek_pengirim` varchar(20) NOT NULL,
  `atas_nama_pengirim` varchar(128) NOT NULL,
  `nominal` int(11) NOT NULL,
  `bukti_transfer` varchar(128) NOT NULL,
  `tanggal` date NOT NULL,
  `status` enum('CHECK','SUCCESS','FAILED','') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
